...
require 'webmock/rspec'
  ...
  stub_request(:post, "https://www.reddit.com/api/v1/access_token").
     ...
     to_return(status: 200, body: JSON.generate({access_token: 123}), headers: {})
   stub_request(:get, "https://oauth.reddit.com/r/frugalmalefashion/new?api_type=json&raw_json=1").
       with(headers: {'Authorization'=>'Bearer 123', 'Connection'=>'Keep-Alive', 'Host'=>'oauth.reddit.com', 'User-Agent'=>'Redd:FashionTexter:v1.0.0 (by /u/the4oclockhero)'}).
       to_return(status: 200, body: "{\n\"title\": \n\"'Nike Air Force 1s on Sale! use code Shoes'\", \n\"link_flair\": \n\"'[Deal/Sale]'\", \n\"created\": \n\"'1502176403'\"}", headers: {})
  end
end
